...
export function SiteQr() {
  ...
  return (
    <div className="inline-flex flex-col items-center rounded-xl bg-surface-container-lowest p-6 shadow-[0_24px_64px_-32px_rgba(47,51,49,0.18)]">
      <div className="rounded-lg bg-white p-3">
        <QRCode value={url} size={180} level="M" fgColor="#2f3331" bgColor="#ffffff" />
      </div>
